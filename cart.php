   ...
   <section class="shopping-cart">
      ...
      <h1 class="head1">Shopping Cart</h1>
      ...
      <table>
         ...
         <tbody>
            ...
            <tr>
               <td><img src="./img/<?php echo $fetch_cart['image']; ?>" height="" alt=""></td>
            ...
            <tr class="table-bottom">
               <td><a href="home.php" class="option-btn1" style="margin-top: 0;">Continue shopping</a></td>
